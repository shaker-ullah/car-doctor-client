...
const Banner = () => {
    return (
        ...
        <div id="slide1" className="carousel-item  relative w-full">
                ...
                <div className="absolute rounded-xl h-full pl-8 w-1/2  bottom-0  left-0  bg-gradient-to-r from-[#151515] to-[rgba(21,21,21, 0)]">
                    ...
                    <button className='btn btn-outline btn-primary'>Discover</button>
